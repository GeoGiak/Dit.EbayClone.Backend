...
namespace Dit.EbayClone.Backend.Domain.Migrations
{
    ...
    [Migration("20250927233113_IntroduceHistoricTables")]
    partial class IntroduceHistoricTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dit.EbayClone.Backend.Domain.Models.BidHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dit.EbayClone.Backend.Domain.Models.BidHistory", b =>
                {
                    b.HasOne("Dit.EbayClone.Backend.Domain.Models.AuctionHistory", "Auction")
                        .WithMany("Bids")
                        .HasForeignKey("AuctionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
